...
--
-- Host: localhost
-- Generation Time: Jun 22, 2021 at 02:34 PM
...
INSERT INTO `locations` (`division`, `district`, `upazila`) VALUES
...
('Rajshahi', 'Nawabganj', 'Bholahat'),
('Rajshahi', 'Nawabganj', 'Gomastapur'),
('Rajshahi', 'Nawabganj', 'Nachole'),
('Rajshahi', 'Nawabganj', 'Nawabganj Sadar'),
('Rajshahi', 'Nawabganj', 'Shibganj'),
('Rajshahi', 'Pabna', 'Ataikula'),
...
('Rajshahi', 'Rajshahi', 'Boalia Thana'),
('Rajshahi', 'Rajshahi', 'Matihar Thana'),
('Rajshahi', 'Rajshahi', 'Rajpara Thana'),
('Rajshahi', 'Rajshahi', 'Shah Mokdum Thana'),
...
('Barisal', 'Pirojpur', 'Zianagor'),
('Chittagong', 'Bandarban', 'Ali Kadam'),
...
('Chittagong', 'Brahmanbaria', 'Bancharampur'),
...
('Chittagong', 'Chittagong', 'Bandor (Chittagong Port) Thana'),
('Chittagong', 'Chittagong', 'Chandgaon Thana'),
('Chittagong', 'Chittagong', 'Double Mooring Thana'),
('Chittagong', 'Chittagong', 'Kotwali Thana'),
('Chittagong', 'Chittagong', 'Pahartali Thana'),
('Chittagong', 'Chittagong', 'Panchlaish Thana'),
('Chittagong', 'Comilla', 'Barura'),
('Chittagong', 'Comilla', 'Brahmanpara'),
...
('Chittagong', 'Comilla', 'Monohargonj'),
...
('Chittagong', 'Khagrachhari', 'Khagrachhari'),
...
('Dhaka', 'Manikganj', 'Manikgonj Sadar'),
...
('Khulna', 'Jhenaida', 'Harinakunda'),
('Khulna', 'Jhenaida', 'Jhenaidah Sadar'),
('Khulna', 'Jhenaida', 'Kaliganj'),
('Khulna', 'Jhenaida', 'Kotchandpur'),
('Khulna', 'Jhenaida', 'Maheshpur'),
('Khulna', 'Jhenaida', 'Shailkupa'),
...
('Khulna', 'Khulna', 'Daulatpur Thana'),
('Khulna', 'Khulna', 'Khalishpur Thana'),
('Khulna', 'Khulna', 'Khan Jahan Ali Thana'),
('Khulna', 'Khulna', 'Kotwali Thana'),
('Khulna', 'Khulna', 'Sonadanga Thana'),
('Khulna', 'Khulna', 'Harintana Thana'),
